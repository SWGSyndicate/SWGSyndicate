...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'heraldScreenPlay' ====
if not heraldScreenPlay then heraldScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(heraldScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function heraldScreenPlay:start()
