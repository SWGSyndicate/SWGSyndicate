...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'NabooStaticSpawnsNorthScreenPlay' ====
if not NabooStaticSpawnsNorthScreenPlay then NabooStaticSpawnsNorthScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(NabooStaticSpawnsNorthScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function NabooStaticSpawnsNorthScreenPlay:start()
