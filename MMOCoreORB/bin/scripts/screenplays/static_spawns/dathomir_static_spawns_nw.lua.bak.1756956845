...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'DathomirStaticSpawnsNwScreenPlay' ====
if not DathomirStaticSpawnsNwScreenPlay then DathomirStaticSpawnsNwScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(DathomirStaticSpawnsNwScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function DathomirStaticSpawnsNwScreenPlay:start()
