...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'RoriStaticSpawnsScreenPlay' ====
if not RoriStaticSpawnsScreenPlay then RoriStaticSpawnsScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(RoriStaticSpawnsScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function RoriStaticSpawnsScreenPlay:start()
