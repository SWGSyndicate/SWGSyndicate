...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'DathomirStaticSpawnsSeScreenPlay' ====
if not DathomirStaticSpawnsSeScreenPlay then DathomirStaticSpawnsSeScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(DathomirStaticSpawnsSeScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function DathomirStaticSpawnsSeScreenPlay:start()
