...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'TalusStaticSpawnsSouthScreenPlay' ====
if not TalusStaticSpawnsSouthScreenPlay then TalusStaticSpawnsSouthScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(TalusStaticSpawnsSouthScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function TalusStaticSpawnsSouthScreenPlay:start()
