...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'FortTuskenScreenPlay' ====
if not FortTuskenScreenPlay then FortTuskenScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(FortTuskenScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function FortTuskenScreenPlay:start()
