...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'RoriRebelMilitaryBaseScreenPlay' ====
if not RoriRebelMilitaryBaseScreenPlay then RoriRebelMilitaryBaseScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(RoriRebelMilitaryBaseScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function RoriRebelMilitaryBaseScreenPlay:start()
