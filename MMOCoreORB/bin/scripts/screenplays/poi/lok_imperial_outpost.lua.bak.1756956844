...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'LokImperialOutpostScreenPlay' ====
if not LokImperialOutpostScreenPlay then LokImperialOutpostScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(LokImperialOutpostScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function LokImperialOutpostScreenPlay:start()
