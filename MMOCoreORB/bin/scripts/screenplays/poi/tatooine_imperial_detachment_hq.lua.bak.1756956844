...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'ImperialDetachmentHQScreenPlay' ====
if not ImperialDetachmentHQScreenPlay then ImperialDetachmentHQScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(ImperialDetachmentHQScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function ImperialDetachmentHQScreenPlay:start()
