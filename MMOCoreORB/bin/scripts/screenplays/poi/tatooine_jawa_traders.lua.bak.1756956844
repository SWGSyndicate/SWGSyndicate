...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'JawaTradersScreenPlay' ====
if not JawaTradersScreenPlay then JawaTradersScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(JawaTradersScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function JawaTradersScreenPlay:start()
