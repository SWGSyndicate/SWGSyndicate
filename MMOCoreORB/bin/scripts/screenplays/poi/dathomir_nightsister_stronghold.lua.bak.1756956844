...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'NightSisterStrongholdScreenPlay' ====
if not NightSisterStrongholdScreenPlay then NightSisterStrongholdScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(NightSisterStrongholdScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function NightSisterStrongholdScreenPlay:start()
