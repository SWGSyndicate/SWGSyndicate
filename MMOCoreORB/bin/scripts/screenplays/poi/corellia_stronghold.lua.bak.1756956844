...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'StrongholdScreenPlay' ====
if not StrongholdScreenPlay then StrongholdScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(StrongholdScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function StrongholdScreenPlay:start()
