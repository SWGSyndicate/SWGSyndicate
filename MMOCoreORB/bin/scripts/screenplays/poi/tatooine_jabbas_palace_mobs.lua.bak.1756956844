...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'TatooineJabbasPalaceMobsScreenPlay' ====
if not TatooineJabbasPalaceMobsScreenPlay then TatooineJabbasPalaceMobsScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(TatooineJabbasPalaceMobsScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function TatooineJabbasPalaceMobsScreenPlay:start()
