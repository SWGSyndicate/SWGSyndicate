...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'WoolamanderTempleScreenPlay' ====
if not WoolamanderTempleScreenPlay then WoolamanderTempleScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(WoolamanderTempleScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function WoolamanderTempleScreenPlay:start()
