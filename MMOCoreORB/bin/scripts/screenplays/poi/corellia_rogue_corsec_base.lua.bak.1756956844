...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'CorsecBaseScreenPlay' ====
if not CorsecBaseScreenPlay then CorsecBaseScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(CorsecBaseScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function CorsecBaseScreenPlay:start()
