...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'CobralHideoutScreenPlay' ====
if not CobralHideoutScreenPlay then CobralHideoutScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(CobralHideoutScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function CobralHideoutScreenPlay:start()
