...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'nashal_racetrack_screenplay' ====
if not nashal_racetrack_screenplay then nashal_racetrack_screenplay = ScreenPlay:new{ numberOfActs = 0 } end
if type(nashal_racetrack_screenplay.start) ~= "function" and type(start) ~= "function" then
  function nashal_racetrack_screenplay:start()
