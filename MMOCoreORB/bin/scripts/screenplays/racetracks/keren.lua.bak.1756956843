...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'keren_racetrack_screenplay' ====
if not keren_racetrack_screenplay then keren_racetrack_screenplay = ScreenPlay:new{ numberOfActs = 0 } end
if type(keren_racetrack_screenplay.start) ~= "function" and type(start) ~= "function" then
  function keren_racetrack_screenplay:start()
