...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'mosespa_racetrack_screenplay' ====
if not mosespa_racetrack_screenplay then mosespa_racetrack_screenplay = ScreenPlay:new{ numberOfActs = 0 } end
if type(mosespa_racetrack_screenplay.start) ~= "function" and type(start) ~= "function" then
  function mosespa_racetrack_screenplay:start()
