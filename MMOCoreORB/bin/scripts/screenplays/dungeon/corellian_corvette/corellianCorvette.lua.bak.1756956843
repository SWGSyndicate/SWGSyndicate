...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'CorellianCorvette' ====
if not CorellianCorvette then CorellianCorvette = ScreenPlay:new{ numberOfActs = 0 } end
if type(CorellianCorvette.start) ~= "function" and type(start) ~= "function" then
  function CorellianCorvette:start()
