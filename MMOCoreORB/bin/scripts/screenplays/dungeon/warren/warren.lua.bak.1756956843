...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'Warren' ====
if not Warren then Warren = ScreenPlay:new{ numberOfActs = 0 } end
if type(Warren.start) ~= "function" and type(start) ~= "function" then
  function Warren:start()
