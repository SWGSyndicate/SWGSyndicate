...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'GeonosianLab' ====
if not GeonosianLab then GeonosianLab = ScreenPlay:new{ numberOfActs = 0 } end
if type(GeonosianLab.start) ~= "function" and type(start) ~= "function" then
  function GeonosianLab:start()
