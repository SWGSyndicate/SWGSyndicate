...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'TatooineMosEisleyScreenPlay' ====
if not TatooineMosEisleyScreenPlay then TatooineMosEisleyScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(TatooineMosEisleyScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function TatooineMosEisleyScreenPlay:start()
