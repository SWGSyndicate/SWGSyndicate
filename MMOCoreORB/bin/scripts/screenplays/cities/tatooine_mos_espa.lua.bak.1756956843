...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'TatooineMosEspaScreenPlay' ====
if not TatooineMosEspaScreenPlay then TatooineMosEspaScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(TatooineMosEspaScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function TatooineMosEspaScreenPlay:start()
