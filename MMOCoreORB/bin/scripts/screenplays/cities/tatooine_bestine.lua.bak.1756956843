...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'TatooineBestineScreenPlay' ====
if not TatooineBestineScreenPlay then TatooineBestineScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(TatooineBestineScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function TatooineBestineScreenPlay:start()
