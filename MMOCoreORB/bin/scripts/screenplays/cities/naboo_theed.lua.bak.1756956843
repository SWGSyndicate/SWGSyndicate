...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'NabooTheedScreenPlay' ====
if not NabooTheedScreenPlay then NabooTheedScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(NabooTheedScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function NabooTheedScreenPlay:start()
