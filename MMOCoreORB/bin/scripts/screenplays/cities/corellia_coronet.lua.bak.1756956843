...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'CorelliaCoronetScreenPlay' ====
if not CorelliaCoronetScreenPlay then CorelliaCoronetScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(CorelliaCoronetScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function CorelliaCoronetScreenPlay:start()
