...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'DantooineImperialOutpostScreenPlay' ====
if not DantooineImperialOutpostScreenPlay then DantooineImperialOutpostScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(DantooineImperialOutpostScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function DantooineImperialOutpostScreenPlay:start()
