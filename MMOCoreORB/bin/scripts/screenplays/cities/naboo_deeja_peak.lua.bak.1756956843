...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'NabooDeejaPeakScreenPlay' ====
if not NabooDeejaPeakScreenPlay then NabooDeejaPeakScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(NabooDeejaPeakScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function NabooDeejaPeakScreenPlay:start()
