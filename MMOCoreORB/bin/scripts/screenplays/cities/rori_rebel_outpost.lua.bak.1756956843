...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'RoriRebelOutpostScreenPlay' ====
if not RoriRebelOutpostScreenPlay then RoriRebelOutpostScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(RoriRebelOutpostScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function RoriRebelOutpostScreenPlay:start()
