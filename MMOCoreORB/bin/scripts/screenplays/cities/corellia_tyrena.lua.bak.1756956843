...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'CorelliaTyrenaScreenPlay' ====
if not CorelliaTyrenaScreenPlay then CorelliaTyrenaScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(CorelliaTyrenaScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function CorelliaTyrenaScreenPlay:start()
