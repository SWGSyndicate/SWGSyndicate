...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'TatooineWayfarScreenPlay' ====
if not TatooineWayfarScreenPlay then TatooineWayfarScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(TatooineWayfarScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function TatooineWayfarScreenPlay:start()
