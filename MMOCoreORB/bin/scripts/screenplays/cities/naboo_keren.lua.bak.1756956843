...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'NabooKerenScreenPlay' ====
if not NabooKerenScreenPlay then NabooKerenScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(NabooKerenScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function NabooKerenScreenPlay:start()
