...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'Yavin4MiningOutpostScreenPlay' ====
if not Yavin4MiningOutpostScreenPlay then Yavin4MiningOutpostScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(Yavin4MiningOutpostScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function Yavin4MiningOutpostScreenPlay:start()
