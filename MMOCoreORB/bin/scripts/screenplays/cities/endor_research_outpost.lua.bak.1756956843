...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'EndorResearchOutpostScreenPlay' ====
if not EndorResearchOutpostScreenPlay then EndorResearchOutpostScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(EndorResearchOutpostScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function EndorResearchOutpostScreenPlay:start()
