...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'lifeDayScreenplay' ====
if not lifeDayScreenplay then lifeDayScreenplay = ScreenPlay:new{ numberOfActs = 0 } end
if type(lifeDayScreenplay.start) ~= "function" and type(start) ~= "function" then
  function lifeDayScreenplay:start()
