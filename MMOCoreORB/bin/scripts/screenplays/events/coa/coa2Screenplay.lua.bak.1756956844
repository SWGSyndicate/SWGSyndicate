...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'Coa2Screenplay' ====
if not Coa2Screenplay then Coa2Screenplay = ScreenPlay:new{ numberOfActs = 0 } end
if type(Coa2Screenplay.start) ~= "function" and type(start) ~= "function" then
  function Coa2Screenplay:start()
