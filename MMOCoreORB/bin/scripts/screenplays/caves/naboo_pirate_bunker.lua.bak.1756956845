...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'NabooPirateBunkerScreenPlay' ====
if not NabooPirateBunkerScreenPlay then NabooPirateBunkerScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(NabooPirateBunkerScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function NabooPirateBunkerScreenPlay:start()
