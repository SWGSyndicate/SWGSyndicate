...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'TuskenBunkerScreenPlay' ====
if not TuskenBunkerScreenPlay then TuskenBunkerScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(TuskenBunkerScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function TuskenBunkerScreenPlay:start()
