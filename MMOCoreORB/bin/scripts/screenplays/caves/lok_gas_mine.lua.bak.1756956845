...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'LokGasMineScreenPlay' ====
if not LokGasMineScreenPlay then LokGasMineScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(LokGasMineScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function LokGasMineScreenPlay:start()
