...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'DroidEngineerCaveScreenPlay' ====
if not DroidEngineerCaveScreenPlay then DroidEngineerCaveScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(DroidEngineerCaveScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function DroidEngineerCaveScreenPlay:start()
