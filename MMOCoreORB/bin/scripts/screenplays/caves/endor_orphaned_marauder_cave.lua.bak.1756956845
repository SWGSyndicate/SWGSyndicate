...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'EndorOrphanedMarauderCaveScreenPlay' ====
if not EndorOrphanedMarauderCaveScreenPlay then EndorOrphanedMarauderCaveScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(EndorOrphanedMarauderCaveScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function EndorOrphanedMarauderCaveScreenPlay:start()
