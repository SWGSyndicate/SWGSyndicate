...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'KobolaBunkerScreenPlay' ====
if not KobolaBunkerScreenPlay then KobolaBunkerScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(KobolaBunkerScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function KobolaBunkerScreenPlay:start()
