...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'NymPirateCaveScreenPlay' ====
if not NymPirateCaveScreenPlay then NymPirateCaveScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(NymPirateCaveScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function NymPirateCaveScreenPlay:start()
