...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'TalusGiantDecayMiteCaveScreenPlay' ====
if not TalusGiantDecayMiteCaveScreenPlay then TalusGiantDecayMiteCaveScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(TalusGiantDecayMiteCaveScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function TalusGiantDecayMiteCaveScreenPlay:start()
