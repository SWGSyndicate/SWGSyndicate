...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'RoriBlackSunOutpostBunkerScreenPlay' ====
if not RoriBlackSunOutpostBunkerScreenPlay then RoriBlackSunOutpostBunkerScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(RoriBlackSunOutpostBunkerScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function RoriBlackSunOutpostBunkerScreenPlay:start()
