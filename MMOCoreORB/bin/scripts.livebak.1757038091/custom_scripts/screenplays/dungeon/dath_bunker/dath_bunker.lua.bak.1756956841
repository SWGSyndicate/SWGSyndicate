...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'DathBunkerScreenPlay' ====
if not DathBunkerScreenPlay then DathBunkerScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(DathBunkerScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function DathBunkerScreenPlay:start()
