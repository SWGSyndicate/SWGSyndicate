...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'CrackdownCantina' ====
if not CrackdownCantina then CrackdownCantina = ScreenPlay:new{ numberOfActs = 0 } end
if type(CrackdownCantina.start) ~= "function" and type(start) ~= "function" then
  function CrackdownCantina:start()
