...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'AncientKraytSkeletonScreenPlay' ====
if not AncientKraytSkeletonScreenPlay then AncientKraytSkeletonScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(AncientKraytSkeletonScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function AncientKraytSkeletonScreenPlay:start()
