...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'RoriPoacherVsCreatureBattleScreenPlay' ====
if not RoriPoacherVsCreatureBattleScreenPlay then RoriPoacherVsCreatureBattleScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(RoriPoacherVsCreatureBattleScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function RoriPoacherVsCreatureBattleScreenPlay:start()
