...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'GunganTempleScreenPlay' ====
if not GunganTempleScreenPlay then GunganTempleScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(GunganTempleScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function GunganTempleScreenPlay:start()
