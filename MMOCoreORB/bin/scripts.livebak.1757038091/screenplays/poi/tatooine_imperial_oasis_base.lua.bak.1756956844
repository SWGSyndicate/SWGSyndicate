...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'TatooineImperialOasisBaseScreenPlay' ====
if not TatooineImperialOasisBaseScreenPlay then TatooineImperialOasisBaseScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(TatooineImperialOasisBaseScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function TatooineImperialOasisBaseScreenPlay:start()
