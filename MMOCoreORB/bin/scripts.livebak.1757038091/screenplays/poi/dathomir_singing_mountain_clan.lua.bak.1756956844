...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'SingingMountainClanScreenPlay' ====
if not SingingMountainClanScreenPlay then SingingMountainClanScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(SingingMountainClanScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function SingingMountainClanScreenPlay:start()
