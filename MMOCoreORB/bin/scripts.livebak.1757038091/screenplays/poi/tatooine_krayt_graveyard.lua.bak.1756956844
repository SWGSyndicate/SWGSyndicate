...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'KraytGraveyardScreenPlay' ====
if not KraytGraveyardScreenPlay then KraytGraveyardScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(KraytGraveyardScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function KraytGraveyardScreenPlay:start()
