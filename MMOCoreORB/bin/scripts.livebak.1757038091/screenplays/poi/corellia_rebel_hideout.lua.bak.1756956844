...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'RebelHideoutScreenPlay' ====
if not RebelHideoutScreenPlay then RebelHideoutScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(RebelHideoutScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function RebelHideoutScreenPlay:start()
