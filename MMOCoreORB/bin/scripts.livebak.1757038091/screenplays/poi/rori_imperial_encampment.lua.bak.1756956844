...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'RoriImperialEncampmentScreenPlay' ====
if not RoriImperialEncampmentScreenPlay then RoriImperialEncampmentScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(RoriImperialEncampmentScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function RoriImperialEncampmentScreenPlay:start()
