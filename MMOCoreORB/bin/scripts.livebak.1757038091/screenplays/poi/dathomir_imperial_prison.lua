...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'ImperialPrisonScreenPlay' ====
if not ImperialPrisonScreenPlay then ImperialPrisonScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(ImperialPrisonScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function ImperialPrisonScreenPlay:start()
