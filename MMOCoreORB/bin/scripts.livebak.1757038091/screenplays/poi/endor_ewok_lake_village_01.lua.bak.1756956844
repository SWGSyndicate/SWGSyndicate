...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'EndorEwokLakeVillage01ScreenPlay' ====
if not EndorEwokLakeVillage01ScreenPlay then EndorEwokLakeVillage01ScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(EndorEwokLakeVillage01ScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function EndorEwokLakeVillage01ScreenPlay:start()
