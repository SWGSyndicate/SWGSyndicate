...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'ImperialVsGunganScreenPlay' ====
if not ImperialVsGunganScreenPlay then ImperialVsGunganScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(ImperialVsGunganScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function ImperialVsGunganScreenPlay:start()
