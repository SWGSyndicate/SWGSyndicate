...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'TalusCorsecVsFlailBattleScreenPlay' ====
if not TalusCorsecVsFlailBattleScreenPlay then TalusCorsecVsFlailBattleScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(TalusCorsecVsFlailBattleScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function TalusCorsecVsFlailBattleScreenPlay:start()
