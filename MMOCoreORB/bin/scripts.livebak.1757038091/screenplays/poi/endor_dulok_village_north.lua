...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'EndorDulokVillageNorthScreenPlay' ====
if not EndorDulokVillageNorthScreenPlay then EndorDulokVillageNorthScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(EndorDulokVillageNorthScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function EndorDulokVillageNorthScreenPlay:start()
