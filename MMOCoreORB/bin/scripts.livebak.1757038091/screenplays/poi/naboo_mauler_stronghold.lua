...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'MaulerStrongholdScreenPlay' ====
if not MaulerStrongholdScreenPlay then MaulerStrongholdScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(MaulerStrongholdScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function MaulerStrongholdScreenPlay:start()
