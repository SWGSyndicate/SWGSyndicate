...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'DathomirSarlaccScreenPlay' ====
if not DathomirSarlaccScreenPlay then DathomirSarlaccScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(DathomirSarlaccScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function DathomirSarlaccScreenPlay:start()
