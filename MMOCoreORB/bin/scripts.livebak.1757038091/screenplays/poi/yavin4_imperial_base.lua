...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'Yavin4ImperialBaseScreenPlay' ====
if not Yavin4ImperialBaseScreenPlay then Yavin4ImperialBaseScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(Yavin4ImperialBaseScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function Yavin4ImperialBaseScreenPlay:start()
