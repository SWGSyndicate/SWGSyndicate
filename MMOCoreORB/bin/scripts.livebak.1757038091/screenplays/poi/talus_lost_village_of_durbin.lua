...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'LostVillageofDurbinScreenPlay' ====
if not LostVillageofDurbinScreenPlay then LostVillageofDurbinScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(LostVillageofDurbinScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function LostVillageofDurbinScreenPlay:start()
