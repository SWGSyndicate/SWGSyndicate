...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'RoriGungansSwampTownScreenPlay' ====
if not RoriGungansSwampTownScreenPlay then RoriGungansSwampTownScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(RoriGungansSwampTownScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function RoriGungansSwampTownScreenPlay:start()
