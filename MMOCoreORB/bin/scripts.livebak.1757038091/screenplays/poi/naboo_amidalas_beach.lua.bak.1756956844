...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'NabooAmidalasBeachScreenPlay' ====
if not NabooAmidalasBeachScreenPlay then NabooAmidalasBeachScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(NabooAmidalasBeachScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function NabooAmidalasBeachScreenPlay:start()
