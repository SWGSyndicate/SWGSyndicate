...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'GarynRaidersBunkerScreenPlay' ====
if not GarynRaidersBunkerScreenPlay then GarynRaidersBunkerScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(GarynRaidersBunkerScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function GarynRaidersBunkerScreenPlay:start()
