...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'DathomirCrashSiteScreenPlay' ====
if not DathomirCrashSiteScreenPlay then DathomirCrashSiteScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(DathomirCrashSiteScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function DathomirCrashSiteScreenPlay:start()
