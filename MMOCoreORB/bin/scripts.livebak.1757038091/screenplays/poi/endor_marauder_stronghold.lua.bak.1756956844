...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'EndorMarauderStrongholdScreenPlay' ====
if not EndorMarauderStrongholdScreenPlay then EndorMarauderStrongholdScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(EndorMarauderStrongholdScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function EndorMarauderStrongholdScreenPlay:start()
