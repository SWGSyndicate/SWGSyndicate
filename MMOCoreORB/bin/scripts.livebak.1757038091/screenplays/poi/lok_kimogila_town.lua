...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'LokKimogilaTownScreenPlay' ====
if not LokKimogilaTownScreenPlay then LokKimogilaTownScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(LokKimogilaTownScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function LokKimogilaTownScreenPlay:start()
