...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'BlueleafTempleScreenPlay' ====
if not BlueleafTempleScreenPlay then BlueleafTempleScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(BlueleafTempleScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function BlueleafTempleScreenPlay:start()
