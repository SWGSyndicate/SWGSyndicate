...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'NightSisterVsSingingMountainClanScreenPlay' ====
if not NightSisterVsSingingMountainClanScreenPlay then NightSisterVsSingingMountainClanScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(NightSisterVsSingingMountainClanScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function NightSisterVsSingingMountainClanScreenPlay:start()
