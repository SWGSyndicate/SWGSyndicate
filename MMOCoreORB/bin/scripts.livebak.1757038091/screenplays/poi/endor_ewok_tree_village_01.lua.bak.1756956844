...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'EndorEwokTreeVillage01ScreenPlay' ====
if not EndorEwokTreeVillage01ScreenPlay then EndorEwokTreeVillage01ScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(EndorEwokTreeVillage01ScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function EndorEwokTreeVillage01ScreenPlay:start()
