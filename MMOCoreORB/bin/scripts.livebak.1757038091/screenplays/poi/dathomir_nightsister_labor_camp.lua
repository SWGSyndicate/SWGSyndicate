...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'NightSisterLaborCampScreenPlay' ====
if not NightSisterLaborCampScreenPlay then NightSisterLaborCampScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(NightSisterLaborCampScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function NightSisterLaborCampScreenPlay:start()
