...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'BloodRazerTransportScreenPlay' ====
if not BloodRazerTransportScreenPlay then BloodRazerTransportScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(BloodRazerTransportScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function BloodRazerTransportScreenPlay:start()
