...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'NabooMordranScreenPlay' ====
if not NabooMordranScreenPlay then NabooMordranScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(NabooMordranScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function NabooMordranScreenPlay:start()
