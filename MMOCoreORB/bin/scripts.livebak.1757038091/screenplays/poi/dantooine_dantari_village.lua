...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'DantariVillageScreenPlay' ====
if not DantariVillageScreenPlay then DantariVillageScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(DantariVillageScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function DantariVillageScreenPlay:start()
