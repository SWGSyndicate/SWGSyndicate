...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'EndorEwokTreeVillage02ScreenPlay' ====
if not EndorEwokTreeVillage02ScreenPlay then EndorEwokTreeVillage02ScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(EndorEwokTreeVillage02ScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function EndorEwokTreeVillage02ScreenPlay:start()
