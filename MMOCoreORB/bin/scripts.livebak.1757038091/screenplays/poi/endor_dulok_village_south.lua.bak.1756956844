...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'EndorDulokVillageSouthScreenPlay' ====
if not EndorDulokVillageSouthScreenPlay then EndorDulokVillageSouthScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(EndorDulokVillageSouthScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function EndorDulokVillageSouthScreenPlay:start()
