...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'agrilatswamp_racetrack_screenplay' ====
if not agrilatswamp_racetrack_screenplay then agrilatswamp_racetrack_screenplay = ScreenPlay:new{ numberOfActs = 0 } end
if type(agrilatswamp_racetrack_screenplay.start) ~= "function" and type(start) ~= "function" then
  function agrilatswamp_racetrack_screenplay:start()
