...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'lok_racetrack_screenplay' ====
if not lok_racetrack_screenplay then lok_racetrack_screenplay = ScreenPlay:new{ numberOfActs = 0 } end
if type(lok_racetrack_screenplay.start) ~= "function" and type(start) ~= "function" then
  function lok_racetrack_screenplay:start()
