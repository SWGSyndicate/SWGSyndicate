...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'narmle_racetrack_screenplay' ====
if not narmle_racetrack_screenplay then narmle_racetrack_screenplay = ScreenPlay:new{ numberOfActs = 0 } end
if type(narmle_racetrack_screenplay.start) ~= "function" and type(start) ~= "function" then
  function narmle_racetrack_screenplay:start()
