...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'AfarathuCaveScreenPlay' ====
if not AfarathuCaveScreenPlay then AfarathuCaveScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(AfarathuCaveScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function AfarathuCaveScreenPlay:start()
