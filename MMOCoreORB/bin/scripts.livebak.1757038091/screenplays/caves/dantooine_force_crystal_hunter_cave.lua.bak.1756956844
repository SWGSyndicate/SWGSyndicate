...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'ForceCrystalCaveScreenPlay' ====
if not ForceCrystalCaveScreenPlay then ForceCrystalCaveScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(ForceCrystalCaveScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function ForceCrystalCaveScreenPlay:start()
