...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'SpiderClanCaveScreenPlay' ====
if not SpiderClanCaveScreenPlay then SpiderClanCaveScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(SpiderClanCaveScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function SpiderClanCaveScreenPlay:start()
