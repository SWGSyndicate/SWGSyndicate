...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'LordNyaxCultScreenPlay' ====
if not LordNyaxCultScreenPlay then LordNyaxCultScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(LordNyaxCultScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function LordNyaxCultScreenPlay:start()
