...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'DrallCaveScreenPlay' ====
if not DrallCaveScreenPlay then DrallCaveScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(DrallCaveScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function DrallCaveScreenPlay:start()
