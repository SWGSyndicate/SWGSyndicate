...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'HuttHideoutScreenPlay' ====
if not HuttHideoutScreenPlay then HuttHideoutScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(HuttHideoutScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function HuttHideoutScreenPlay:start()
