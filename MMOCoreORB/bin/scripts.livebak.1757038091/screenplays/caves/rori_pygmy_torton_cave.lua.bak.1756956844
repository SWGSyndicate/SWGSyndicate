...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'TortonCaveScreenPlay' ====
if not TortonCaveScreenPlay then TortonCaveScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(TortonCaveScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function TortonCaveScreenPlay:start()
