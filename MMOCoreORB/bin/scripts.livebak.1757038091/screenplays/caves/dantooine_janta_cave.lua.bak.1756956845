...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'JantaCaveScreenPlay' ====
if not JantaCaveScreenPlay then JantaCaveScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(JantaCaveScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function JantaCaveScreenPlay:start()
