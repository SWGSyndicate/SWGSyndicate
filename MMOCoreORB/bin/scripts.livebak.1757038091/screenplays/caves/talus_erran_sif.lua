...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'TalusErranSifScreenPlay' ====
if not TalusErranSifScreenPlay then TalusErranSifScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(TalusErranSifScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function TalusErranSifScreenPlay:start()
