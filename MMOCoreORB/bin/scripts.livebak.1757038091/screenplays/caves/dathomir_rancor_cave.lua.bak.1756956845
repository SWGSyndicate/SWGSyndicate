...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'RancorCaveScreenPlay' ====
if not RancorCaveScreenPlay then RancorCaveScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(RancorCaveScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function RancorCaveScreenPlay:start()
