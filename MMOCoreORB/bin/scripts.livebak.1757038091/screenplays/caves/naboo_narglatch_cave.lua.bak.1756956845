...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'NarglatchCaveScreenPlay' ====
if not NarglatchCaveScreenPlay then NarglatchCaveScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(NarglatchCaveScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function NarglatchCaveScreenPlay:start()
