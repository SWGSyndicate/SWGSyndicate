...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'LizardCaveScreenPlay' ====
if not LizardCaveScreenPlay then LizardCaveScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(LizardCaveScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function LizardCaveScreenPlay:start()
