...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'EndorKorgaCaveScreenPlay' ====
if not EndorKorgaCaveScreenPlay then EndorKorgaCaveScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(EndorKorgaCaveScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function EndorKorgaCaveScreenPlay:start()
