...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'BorgleBatCaveScreenPlay' ====
if not BorgleBatCaveScreenPlay then BorgleBatCaveScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(BorgleBatCaveScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function BorgleBatCaveScreenPlay:start()
