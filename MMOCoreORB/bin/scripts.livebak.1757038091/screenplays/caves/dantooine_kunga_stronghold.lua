...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'KungaStrongholdScreenPlay' ====
if not KungaStrongholdScreenPlay then KungaStrongholdScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(KungaStrongholdScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function KungaStrongholdScreenPlay:start()
