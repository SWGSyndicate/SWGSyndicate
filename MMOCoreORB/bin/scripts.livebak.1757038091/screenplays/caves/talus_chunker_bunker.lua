...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'TalusChunkerBunkerScreenPlay' ====
if not TalusChunkerBunkerScreenPlay then TalusChunkerBunkerScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(TalusChunkerBunkerScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function TalusChunkerBunkerScreenPlay:start()
