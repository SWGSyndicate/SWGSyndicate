...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'SennexCaveScreenPlay' ====
if not SennexCaveScreenPlay then SennexCaveScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(SennexCaveScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function SennexCaveScreenPlay:start()
