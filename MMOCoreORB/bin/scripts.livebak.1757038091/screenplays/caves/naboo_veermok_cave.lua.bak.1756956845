...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'VeermokCaveScreenPlay' ====
if not VeermokCaveScreenPlay then VeermokCaveScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(VeermokCaveScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function VeermokCaveScreenPlay:start()
