...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'TalusLostAqualishScreenPlay' ====
if not TalusLostAqualishScreenPlay then TalusLostAqualishScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(TalusLostAqualishScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function TalusLostAqualishScreenPlay:start()
