...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'TalusDetainmentCenterScreenPlay' ====
if not TalusDetainmentCenterScreenPlay then TalusDetainmentCenterScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(TalusDetainmentCenterScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function TalusDetainmentCenterScreenPlay:start()
