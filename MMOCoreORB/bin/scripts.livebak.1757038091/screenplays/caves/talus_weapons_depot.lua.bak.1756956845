...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'TalusWeaponsDepotScreenPlay' ====
if not TalusWeaponsDepotScreenPlay then TalusWeaponsDepotScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(TalusWeaponsDepotScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function TalusWeaponsDepotScreenPlay:start()
