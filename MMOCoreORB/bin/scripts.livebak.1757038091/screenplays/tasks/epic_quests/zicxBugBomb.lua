...
if (not ZicxBugBomb) then ZicxBugBomb = ScreenPlay:new { numberOfActs = 0 } end
-- If start() is missing, provide a no-op.
if (not ZicxBugBomb.start) then
...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'ZicxBugBomb' ====
if not ZicxBugBomb then ZicxBugBomb = ScreenPlay:new{ numberOfActs = 0 } end
if type(ZicxBugBomb.start) ~= "function" and type(start) ~= "function" then
  function ZicxBugBomb:start()
