...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'TheaterManagerScreenPlay' ====
if not TheaterManagerScreenPlay then TheaterManagerScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(TheaterManagerScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function TheaterManagerScreenPlay:start()
