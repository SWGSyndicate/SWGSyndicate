...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'HeroOfTatooineScreenPlay' ====
if not HeroOfTatooineScreenPlay then HeroOfTatooineScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(HeroOfTatooineScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function HeroOfTatooineScreenPlay:start()
