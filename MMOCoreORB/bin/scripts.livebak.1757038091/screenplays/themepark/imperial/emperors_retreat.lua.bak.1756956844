...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'EmperorsRetreatScreenPlay' ====
if not EmperorsRetreatScreenPlay then EmperorsRetreatScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(EmperorsRetreatScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function EmperorsRetreatScreenPlay:start()
