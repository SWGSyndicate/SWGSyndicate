...
if (not ThemeParkMarauderSzingoTerak) then ThemeParkMarauderSzingoTerak = ScreenPlay:new { numberOfActs = 0 } end
-- If start() is missing, provide a no-op.
if (not ThemeParkMarauderSzingoTerak.start) then
  function ThemeParkMarauderSzingoTerak:start()
    return true -- no-op
  end
end
-- ===== /AUTO-ADDED STUB =====

-- ==== SAFETY: auto-added guard for autostarted screenplay 'ThemeParkMarauderSzingoTerak' ====
if not ThemeParkMarauderSzingoTerak then ThemeParkMarauderSzingoTerak = ScreenPlay:new{ numberOfActs = 0 } end
if type(ThemeParkMarauderSzingoTerak.start) ~= "function" and type(start) ~= "function" then
  function ThemeParkMarauderSzingoTerak:start()
