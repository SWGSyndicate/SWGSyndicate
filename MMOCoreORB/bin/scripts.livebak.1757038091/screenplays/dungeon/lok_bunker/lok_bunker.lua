...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'LokBunkerScreenPlay' ====
if not LokBunkerScreenPlay then LokBunkerScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(LokBunkerScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function LokBunkerScreenPlay:start()
