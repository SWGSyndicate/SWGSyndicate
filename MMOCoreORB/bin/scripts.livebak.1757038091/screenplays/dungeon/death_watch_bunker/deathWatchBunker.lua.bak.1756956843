...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'DeathWatchBunkerScreenPlay' ====
if not DeathWatchBunkerScreenPlay then DeathWatchBunkerScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(DeathWatchBunkerScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function DeathWatchBunkerScreenPlay:start()
