...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'BestineMuseumScreenPlay' ====
if not BestineMuseumScreenPlay then BestineMuseumScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(BestineMuseumScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function BestineMuseumScreenPlay:start()
