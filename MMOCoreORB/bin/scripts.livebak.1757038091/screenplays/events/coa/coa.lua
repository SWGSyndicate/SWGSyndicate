...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'CriesOfAlderaan' ====
if not CriesOfAlderaan then CriesOfAlderaan = ScreenPlay:new{ numberOfActs = 0 } end
if type(CriesOfAlderaan.start) ~= "function" and type(start) ~= "function" then
  function CriesOfAlderaan:start()
