...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'eventPromoterScreenplay' ====
if not eventPromoterScreenplay then eventPromoterScreenplay = ScreenPlay:new{ numberOfActs = 0 } end
if type(eventPromoterScreenplay.start) ~= "function" and type(start) ~= "function" then
  function eventPromoterScreenplay:start()
