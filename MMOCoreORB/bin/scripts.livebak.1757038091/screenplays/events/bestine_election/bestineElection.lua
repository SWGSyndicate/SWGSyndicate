...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'BestineElection' ====
if not BestineElection then BestineElection = ScreenPlay:new{ numberOfActs = 0 } end
if type(BestineElection.start) ~= "function" and type(start) ~= "function" then
  function BestineElection:start()
