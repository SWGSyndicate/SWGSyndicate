...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'TatooineStaticSpawnsNorthScreenPlay' ====
if not TatooineStaticSpawnsNorthScreenPlay then TatooineStaticSpawnsNorthScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(TatooineStaticSpawnsNorthScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function TatooineStaticSpawnsNorthScreenPlay:start()
