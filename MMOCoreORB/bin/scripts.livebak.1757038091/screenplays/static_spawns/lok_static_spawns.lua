...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'LokStaticSpawnsScreenPlay' ====
if not LokStaticSpawnsScreenPlay then LokStaticSpawnsScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(LokStaticSpawnsScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function LokStaticSpawnsScreenPlay:start()
