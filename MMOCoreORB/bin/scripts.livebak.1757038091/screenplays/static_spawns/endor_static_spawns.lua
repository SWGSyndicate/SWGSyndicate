...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'EndorStaticSpawnsScreenPlay' ====
if not EndorStaticSpawnsScreenPlay then EndorStaticSpawnsScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(EndorStaticSpawnsScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function EndorStaticSpawnsScreenPlay:start()
