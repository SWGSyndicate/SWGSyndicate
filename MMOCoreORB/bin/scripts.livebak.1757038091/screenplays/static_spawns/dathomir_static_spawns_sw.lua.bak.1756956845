...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'DathomirStaticSpawnsSwScreenPlay' ====
if not DathomirStaticSpawnsSwScreenPlay then DathomirStaticSpawnsSwScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(DathomirStaticSpawnsSwScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function DathomirStaticSpawnsSwScreenPlay:start()
