...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'NabooStaticSpawnsSouthScreenPlay' ====
if not NabooStaticSpawnsSouthScreenPlay then NabooStaticSpawnsSouthScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(NabooStaticSpawnsSouthScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function NabooStaticSpawnsSouthScreenPlay:start()
