...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'DantooineStaticSpawnsScreenPlay' ====
if not DantooineStaticSpawnsScreenPlay then DantooineStaticSpawnsScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(DantooineStaticSpawnsScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function DantooineStaticSpawnsScreenPlay:start()
