...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'TatooineStaticSpawnsSouthScreenPlay' ====
if not TatooineStaticSpawnsSouthScreenPlay then TatooineStaticSpawnsSouthScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(TatooineStaticSpawnsSouthScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function TatooineStaticSpawnsSouthScreenPlay:start()
