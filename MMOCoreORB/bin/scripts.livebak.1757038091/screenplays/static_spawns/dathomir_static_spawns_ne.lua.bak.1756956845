...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'DathomirStaticSpawnsNeScreenPlay' ====
if not DathomirStaticSpawnsNeScreenPlay then DathomirStaticSpawnsNeScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(DathomirStaticSpawnsNeScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function DathomirStaticSpawnsNeScreenPlay:start()
