...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'TalusStaticSpawnsNorthScreenPlay' ====
if not TalusStaticSpawnsNorthScreenPlay then TalusStaticSpawnsNorthScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(TalusStaticSpawnsNorthScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function TalusStaticSpawnsNorthScreenPlay:start()
