...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'CorelliaStaticSpawnsScreenPlay' ====
if not CorelliaStaticSpawnsScreenPlay then CorelliaStaticSpawnsScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(CorelliaStaticSpawnsScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function CorelliaStaticSpawnsScreenPlay:start()
