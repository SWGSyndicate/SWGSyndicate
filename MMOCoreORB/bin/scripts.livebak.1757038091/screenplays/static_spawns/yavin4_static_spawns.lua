...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'Yavin4StaticSpawnsScreenPlay' ====
if not Yavin4StaticSpawnsScreenPlay then Yavin4StaticSpawnsScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(Yavin4StaticSpawnsScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function Yavin4StaticSpawnsScreenPlay:start()
