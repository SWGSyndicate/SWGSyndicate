...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'TatooineMosEnthaScreenPlay' ====
if not TatooineMosEnthaScreenPlay then TatooineMosEnthaScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(TatooineMosEnthaScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function TatooineMosEnthaScreenPlay:start()
