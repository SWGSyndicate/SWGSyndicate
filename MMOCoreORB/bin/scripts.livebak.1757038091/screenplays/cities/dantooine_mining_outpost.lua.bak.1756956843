...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'DantooineMiningOutpostScreenPlay' ====
if not DantooineMiningOutpostScreenPlay then DantooineMiningOutpostScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(DantooineMiningOutpostScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function DantooineMiningOutpostScreenPlay:start()
