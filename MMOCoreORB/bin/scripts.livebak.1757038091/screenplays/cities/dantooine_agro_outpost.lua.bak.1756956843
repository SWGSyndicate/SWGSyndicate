...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'DantooineAgroOutpostScreenPlay' ====
if not DantooineAgroOutpostScreenPlay then DantooineAgroOutpostScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(DantooineAgroOutpostScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function DantooineAgroOutpostScreenPlay:start()
