...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'TalusDearicScreenPlay' ====
if not TalusDearicScreenPlay then TalusDearicScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(TalusDearicScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function TalusDearicScreenPlay:start()
