...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'DathomirScienceOutpostScreenPlay' ====
if not DathomirScienceOutpostScreenPlay then DathomirScienceOutpostScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(DathomirScienceOutpostScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function DathomirScienceOutpostScreenPlay:start()
