...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'TatooineAnchorheadScreenPlay' ====
if not TatooineAnchorheadScreenPlay then TatooineAnchorheadScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(TatooineAnchorheadScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function TatooineAnchorheadScreenPlay:start()
