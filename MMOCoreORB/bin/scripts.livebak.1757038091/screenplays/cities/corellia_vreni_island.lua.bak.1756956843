...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'VreniIslandScreenPlay' ====
if not VreniIslandScreenPlay then VreniIslandScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(VreniIslandScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function VreniIslandScreenPlay:start()
