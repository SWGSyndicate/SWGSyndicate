...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'EndorSmugglerOutpostScreenPlay' ====
if not EndorSmugglerOutpostScreenPlay then EndorSmugglerOutpostScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(EndorSmugglerOutpostScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function EndorSmugglerOutpostScreenPlay:start()
