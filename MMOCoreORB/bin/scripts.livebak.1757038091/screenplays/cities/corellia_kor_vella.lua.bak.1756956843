...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'CorelliaKorVellaScreenPlay' ====
if not CorelliaKorVellaScreenPlay then CorelliaKorVellaScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(CorelliaKorVellaScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function CorelliaKorVellaScreenPlay:start()
