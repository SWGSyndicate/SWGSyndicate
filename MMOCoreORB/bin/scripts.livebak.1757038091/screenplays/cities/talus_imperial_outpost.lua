...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'TalusImperialOutpostScreenPlay' ====
if not TalusImperialOutpostScreenPlay then TalusImperialOutpostScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(TalusImperialOutpostScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function TalusImperialOutpostScreenPlay:start()
