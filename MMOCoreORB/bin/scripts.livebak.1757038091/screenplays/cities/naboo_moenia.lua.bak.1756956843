...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'NabooMoeniaScreenPlay' ====
if not NabooMoeniaScreenPlay then NabooMoeniaScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(NabooMoeniaScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function NabooMoeniaScreenPlay:start()
