...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'BelaVistalScreenPlay' ====
if not BelaVistalScreenPlay then BelaVistalScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(BelaVistalScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function BelaVistalScreenPlay:start()
