...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'DathomirTradeOutpostScreenPlay' ====
if not DathomirTradeOutpostScreenPlay then DathomirTradeOutpostScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(DathomirTradeOutpostScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function DathomirTradeOutpostScreenPlay:start()
