...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'RoriRestussScreenPlay' ====
if not RoriRestussScreenPlay then RoriRestussScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(RoriRestussScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function RoriRestussScreenPlay:start()
