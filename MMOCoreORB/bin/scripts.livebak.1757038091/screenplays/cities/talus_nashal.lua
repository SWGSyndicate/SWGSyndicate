...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'TalusNashalScreenPlay' ====
if not TalusNashalScreenPlay then TalusNashalScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(TalusNashalScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function TalusNashalScreenPlay:start()
