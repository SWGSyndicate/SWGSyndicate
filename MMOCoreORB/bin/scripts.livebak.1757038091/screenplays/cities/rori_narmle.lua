...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'RoriNarmleScreenPlay' ====
if not RoriNarmleScreenPlay then RoriNarmleScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(RoriNarmleScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function RoriNarmleScreenPlay:start()
