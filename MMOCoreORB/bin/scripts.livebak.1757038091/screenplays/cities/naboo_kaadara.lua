...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'NabooKaadaraScreenPlay' ====
if not NabooKaadaraScreenPlay then NabooKaadaraScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(NabooKaadaraScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function NabooKaadaraScreenPlay:start()
