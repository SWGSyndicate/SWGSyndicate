...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'Yavin4LaborOutpostScreenPlay' ====
if not Yavin4LaborOutpostScreenPlay then Yavin4LaborOutpostScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(Yavin4LaborOutpostScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function Yavin4LaborOutpostScreenPlay:start()
