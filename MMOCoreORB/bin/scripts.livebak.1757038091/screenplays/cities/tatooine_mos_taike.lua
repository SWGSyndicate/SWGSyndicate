...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'TatooineMosTaikeScreenPlay' ====
if not TatooineMosTaikeScreenPlay then TatooineMosTaikeScreenPlay = ScreenPlay:new{ numberOfActs = 0 } end
if type(TatooineMosTaikeScreenPlay.start) ~= "function" and type(start) ~= "function" then
  function TatooineMosTaikeScreenPlay:start()
