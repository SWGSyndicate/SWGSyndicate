...
-- ==== SAFETY: auto-added guard for autostarted screenplay 'BattlefieldSpawner' ====
if not BattlefieldSpawner then BattlefieldSpawner = ScreenPlay:new{ numberOfActs = 0 } end
if type(BattlefieldSpawner.start) ~= "function" and type(start) ~= "function" then
  function BattlefieldSpawner:start()
